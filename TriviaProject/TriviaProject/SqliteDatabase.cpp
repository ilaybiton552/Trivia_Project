...
bool SqliteDatabase::open()
{
	...
	if (file_exist != 0) // if the database doesn't exist
	{
		...
		sqlQuery("CREATE TABLE IF NOT EXISTS STATISTICS (USERNAME TEXT NOT NULL, CORRECT_ANSWERS INTEGER NOT NULL, TOTAL_ANSWERS INTEGER NOT NULL, AVERAGE_TIME REAL NOT NULL, GAMES INTEGER NOT NULL, FOREIGN KEY(USERNAME) REFERENCES USERS(USERNAME)); ");
	}
